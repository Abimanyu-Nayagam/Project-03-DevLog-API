...
def download_snippet_md():
    ...
    url = f"http://127.0.0.1:5000/api/export-snippet-md/v1/{snippet_id}"
...
def download_snippet_json():
    ...
    snippet_id = int(input("Enter id of the snippet to download: "))
    url = f"http://127.0.0.1:5000/api/export-snippet-json/v1/{snippet_id}"
    headers = {"Authorization": f"Bearer {token}"}
...
def download_entry_md():
    ...
    url = f"http://127.0.0.1:5000/api/export-entry-md/v1/{entry_id}"
    headers = {"Authorization": f"Bearer {token}"}
...
def download_entry_json():
    ...
    entry_id = int(input("Enter id of the entry to download: "))
    url = f"http://127.0.0.1:5000/api/export-entry-json/v1/{entry_id}"
    headers = {"Authorization": f"Bearer {token}"}
